...
func withOutgoingHeaders(ctx context.Context, headers []string, tlsEnabled bool) (context.Context, error) {
	...
	for _, h := range headers {
		...
		if !tlsEnabled && (keyLower == "authorization" || keyLower == "cookie" || strings.Contains(keyLower, "token") || strings.Contains(keyLower, "secret") || strings.Contains(keyLower, "key") || strings.Contains(keyLower, "password") || strings.Contains(keyLower, "passwd") || strings.Contains(keyLower, "bearer") || strings.Contains(keyLower, "credential") || strings.Contains(keyLower, "session")) {
